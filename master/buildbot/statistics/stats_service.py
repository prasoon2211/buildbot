...
class StatsService(service.ReconfigurableServiceMixin, service.AsyncMultiService):
    ...
    def postStatsValue(self, svc, name, value, series_name, context):
        """
        Generalized API for posting any statistic to each of the
        storage services.
        name: name of the statistic
        value: value of this statistic
        series_name: The time-series name for this data (think of this
        as the table name for the table in which this statistic is stored)
        ...
        (TBD), such as:
           ...
           - ...
        """
        yield svc.postStatsValue(name, value, context, series_name)
